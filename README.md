...
pipeline {
    ...
    stages {
        ...
        stage ("Git Checkout") {
            steps {
                git 'https://github.com/ganeshramanarayana/Devops-project-zomato.git'
            }
        }
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'docker') {
                        ...
                        sh "docker push ganeshram333/zomato:latest "
                    }
                }
            }
        }
        ...
        stage ("Deploy to Container") {
            steps {
                sh 'docker run -d --name zomato -p 3000:3000 ganeshram333/zomato:latest'
            }
        }
    }
    post {
